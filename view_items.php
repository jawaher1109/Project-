            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                      ...
                      <a href="add_item.php" class="btn btn-success pull-right">اضافة منتج جديد </a>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped">';
                              ...
                              echo "<th>تعديل المنتج</th>";
							     echo "<th>حذف المنتج</th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
						...
						<?php
                                       ...
                                       echo "<td>";
                                         ...
                                         echo '<a href="edit_item.php?item_id='. $row['item_id'] .'"  ><span class="fa fa-edit"></span></a>';
									   echo "</td>";
										...
										echo "<td>";
                                         ...
                                         echo '<a href="delete_item.php?item_id='. $row['item_id'] .'"  class="delete"><span class="fa fa-trash"></span></a>';
									   echo "</td>";										  
								  echo "</tr>";
                                }
                                echo "</tbody>";                            
