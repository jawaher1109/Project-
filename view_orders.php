...
<div class="page_div" >
	...
	<p><h1><center>عرض الطلبات</center></h1></p><br>
    <div class="wrapper">
 ...
 <br>
                    ...
                    $sql = "SELECT * FROM shipping_request WHERE order_stat='جاري التوصيل'";
 ...
 <br>
                    ...
                    // Attempt select query execution
                   $sql = "SELECT * FROM shipping_request WHERE order_stat='تم التوصيل'";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                       ...
                                       echo "<td>";
                                         ...
                                         echo '<a href="view_order_details.php?order_id='. $row['order_id'] .'&user_id='. $user_id .'"<h4><span class="fa fa-eye"></h4></span></a>';
									   echo "</td>";
