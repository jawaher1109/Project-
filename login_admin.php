...
<div class="w3-content w3-justify w3-text-grey w3-padding-32" id="login_admin">
<p ><h3><center>دخول المدير</center></h3></p>
    <form action="loging_admin.php" method="post">
      ...
      <p>
       <button class="w3-button w3-light-grey w3-padding-large" type="submit">
		...
		<a href='create_admin.php'> <button class="w3-button w3-light-grey w3-padding-large" type="submit">
          <i class="fa fa-address-card"></i> انشاء مدير جديد
        </button></a>
      </p>
