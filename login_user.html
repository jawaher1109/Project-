...
<div class="w3-main w3-padding-large" style="margin-left:50%">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-32" id="login_user">
<p ><h3><center>دخول المستخدم</center></h3></p>
    <form action="loging_client.php" method="post">
      ...
      <p>
		...
		<a href='create_member.php'> <button class="w3-button w3-light-grey w3-padding-large" type="submit">
          <i class="fa fa-address-card"></i> انشاء مستخدم جديد
        </button></a>
      </p>
